...
const PopupDetailsMovie = ({ movie, handlePopup, handleMovie, addToCart }) => {
    return (
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900/50 backdrop-blur-xs p-5">
            <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full overflow-hidden flex flex-col md:flex-row relative">
                ...
                <button
                    ...
                    className="text-gray-700 rounded-full p-2 cursor-pointer absolute top-2 right-2"
                >
                    <X />
                </button>
                ...
                <div className="p-6 md:p-8 md:w-1/2 flex flex-col justify-between">
                    <div>
                        ...
                        <h2 className="text-2xl font-black text-gray-900 mb-2 leading-tight">{movie.title}</h2>
                        <div className="text-3xl font-black text-gray-800 mb-4 border-b pb-4">
                            S/. {movie.price}
                        </div>
